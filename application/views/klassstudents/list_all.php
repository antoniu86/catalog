    ...
    <div class="col-md-12">
        ...
        <table class="table table-striped table-bordered table-condensed table-responsive table-hover">
            ...
            <tbody>
                ...
                <?php foreach ($klass_students as $value): $element = convert_array_to_object('KlassStudent', $value["KlassStudent"]) ?>
                <?php $klass_user = convert_array_to_object('user', $value["User"]) ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="/student/view/<?php echo $klass_user->id; ?>" data-toggle="tooltip" data-placement="top" title="Vizualizare">
                                <span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span>
                            </a>

                            <?php if ($user->sys() || $user->admin()): ?>
                                &nbsp;&nbsp;
                                <a href="/klassstudents/delete/<?php echo $element->id; ?>/<?php echo $klass_id; ?>/<?php echo $year_id; ?>" data-toggle="tooltip" data-placement="top" title="Sterge">
...
<div class="row">
    <div class="col-md-12">
        <a href="/klassstudents/add_in_klass/<?php echo $klass_id; ?>/<?php echo $year_id; ?>" class="btn btn-default">Adauga</a>
    </div>
</div>