...
<ol class="breadcrumb">
    ...
    <li><a href="/klassteachers/list_all/<?php echo $klass_id; ?>/<?php echo $year_id; ?>">Profesori</a></li>
    <li class="active">Adauga</li>
</ol>


<form action="/klassteachers/save/<?php echo $klass_id; ?>/<?php echo $year_id; ?>" method="POST">
    <div class="row">
        <div class="col-md-12">
            <table class="table table-striped table-bordered table-condensed table-responsive table-hover">
                ...
                <tbody>
                    <?php foreach ($klass_teachers as $value): ?>
