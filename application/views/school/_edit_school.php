...
<input type="text" name="school[name]" id="school_name" class="form-control" value="<?php echo $selected_school->name; ?>"><br>

<label for="school_contact">Contact</label><br>
<textarea name="school[contact]" id="school_contact" class="form-control"><?php echo $selected_school->contact; ?></textarea><br>
